 ...
 * @param num          int    等份数
 */
var styleObj1 = obj1 = progressBar.init('pureColorAnnular', 60, 50, 'rgb(146,80,58)', '#3399FF', 'progressBar', 100);
var styleObj2 = obj2 = progressBar.init('pureColorAnnular', 60, 30, '#CCC', '#3399FF', 'progressBar2', 200);
var styleObj3 = obj3 = progressBar.init('pureColorAnnular', 80, 30, '#CCC', 'rgb(146,80,58)', 'progressBar3', 300);
...
setTimeout(function () {
	...
	setTimeout(function () {
		...
		let addObj6 = obj3 = progressBar.refund(addObj3, 60, 1000);
	},3001);
